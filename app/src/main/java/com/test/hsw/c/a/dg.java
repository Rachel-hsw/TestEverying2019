...
public class dg
{
  ...
  public static dg a(Context paramContext)
  {
    ...
    try
    {
      if (a == null)
      {
        a = new dg(paramContext);
        a.a(new ee(paramContext));
        a.a(new eg(paramContext));
        a.a(new an(paramContext));
        a.a(new ej(paramContext));
        a.a(new ei(paramContext));
        a.a(new eh());
        a.e();
      }
      dg localdg = a;
  ...
  private void a(al paramal)
  {
    ...
    try
    {
      ...
      try
      {
        byte[] arrayOfByte = new cv().a(paramal);
        monitorexit;
        if (arrayOfByte != null)
          ch.a(this.c, arrayOfByte);
        return;
      }
      finally
      {
  ...
  private void g()
  {
    ...
    localal.a(localArrayList);
    localal.a(localHashMap);
    monitorenter;
    try
    {
      this.d = localal;
  ...
  private al h()
  {
    // Byte code:
    //   0: aload_0
    //   1: getfield 51	c/a/dg:c	Ljava/io/File;
    ...
    //   15: dup
    //   16: aload_0
    //   17: getfield 51	c/a/dg:c	Ljava/io/File;
    //   20: invokespecial 173	java/io/FileInputStream:<init>	(Ljava/io/File;)V
    //   23: astore_1
    //   24: aload_1
    //   25: invokestatic 176	c/a/ch:b	(Ljava/io/InputStream;)[B
    //   28: astore 4
    //   30: new 107	c/a/al
    //   33: dup
    //   34: invokespecial 108	c/a/al:<init>	()V
    //   37: astore 5
    //   39: new 178	c/a/cp
    //   42: dup
    //   43: invokespecial 179	c/a/cp:<init>	()V
    //   46: aload 5
    //   48: aload 4
    //   50: invokevirtual 182	c/a/cp:a	(Lc/a/cl;[B)V
    //   53: aload_1
    //   54: invokestatic 185	c/a/ch:c	(Ljava/io/InputStream;)V
    //   57: aload 5
    //   59: areturn
    //   60: astore_2
    //   61: aconst_null
    ...
    //   67: aload_1
    //   68: invokestatic 185	c/a/ch:c	(Ljava/io/InputStream;)V
    //   71: aconst_null
    //   72: areturn
    //   73: astore 6
    //   75: aconst_null
    ...
    //   79: astore_3
    //   80: aload_1
    //   81: invokestatic 185	c/a/ch:c	(Ljava/io/InputStream;)V
    //   84: aload_3
    //   85: athrow
    //   86: astore_3
    //   87: goto -7 -> 80
  ...
  public static class a
  {
    ...
    public void a()
    {
      if (!this.b.isEmpty())
      {
        ...
        fc.a(this.a).edit().putString("invld_id", localStringBuilder.toString()).commit();
      }
    }
    ...
    public void b()
    {
      String str1 = fc.a(this.a).getString("invld_id", null);
