...
public class bv
{
  ...
  private int a(String paramString1, String paramString2)
  {
    ...
    if (m == 0)
    {
      bu.b(a, "getRes(" + paramString2 + "/ " + paramString1 + ")");
      bu.b(a, "Error getting resource. Make sure you have copied all resources (res/) from SDK to your project. ");
      m = 0;
    }
    return m;
  }
  ...
  public static bv a(Context paramContext)
  {
    ...
    {
      if (b == null)
        b = new bv(paramContext.getApplicationContext());
      bv localbv = b;
      return localbv;
    }
    finally
