...
public class ShadowContainer extends ViewGroup {
    ...
    public ShadowContainer(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        float shadowRadius = a.getDimension(R.styleable.ShadowContainer_containerShadowDistance, 0);
        deltaLength = a.getDimension(R.styleable.ShadowContainer_containerToViewLength, 0);
