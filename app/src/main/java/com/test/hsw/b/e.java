  ...
  implements h, i, Cloneable
{
    ...
    throws IOException
  {
    ...
    while (true)
    {
      ...
      int j = paramInputStream.read(localy.b, localy.d, i);
      if (j != -1)
        continue;
      if (!paramBoolean)
        break label110;
    ...
    throws IOException
  {
    ...
    while (true)
    {
      ...
      break;
      return this;
      label144: localObject2 = localObject1;
    }
  }
  ...
  public void a(e parame, long paramLong)
  {
    ...
    while (true)
    {
      ...
      localy5 = null;
      break label81;
      label230: parame.a.a(localy5, (int)paramLong);
      parame.b -= paramLong;
      this.b = (paramLong + this.b);
      return;
      label262: this.a.f.a(localy1).b();
    }
  }
  ...
  public int l()
  {
    ...
    int j = localy.d;
    if (j - i < 4)
      return (0xFF & j()) << 24 | (0xFF & j()) << 16 | (0xFF & j()) << 8 | 0xFF & j();
    byte[] arrayOfByte = localy.b;
    int k = i + 1;
  ...
  public long m()
  {
    ...
    int j = localy.d;
    if (j - i < 8)
      return (0xFFFFFFFF & l()) << 32 | 0xFFFFFFFF & l();
    byte[] arrayOfByte = localy.b;
    int k = i + 1;
