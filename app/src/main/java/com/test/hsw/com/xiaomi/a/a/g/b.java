...
public class b
{
  public static String a(String paramString)
  {
    ...
    {
      c.a("CloudCoder.hash4SHA1 ", localNoSuchAlgorithmException);
      throw new IllegalStateException("failed to SHA1");
    }
    catch (UnsupportedEncodingException localUnsupportedEncodingException)
    {
      while (true)
        c.a("CloudCoder.hash4SHA1 ", localUnsupportedEncodingException);
    }
    catch (Exception localException)
    {
      while (true)
        c.a("CloudCoder.hash4SHA1 ", localException);
    }
  }
 ...
 * Qualified Name:     com.xiaomi.a.a.g.b
