...
public final class w
{
  ...
  private String p()
  {
    return "mobclick_agent_cached_" + c + bt.c(b);
  }
  ...
  public void a(byte[] paramArrayOfByte)
  {
    ...
    try
    {
      ch.a(new File(b.getFilesDir(), str), paramArrayOfByte);
      return;
    }
    catch (Exception localException)
    {
      bu.b("MobclickAgent", localException.getMessage());
    }
  }
  ...
  public byte[] f()
  {
    // Byte code:
    //   0: aload_0
    //   1: invokespecial 160	com/umeng/a/w:p	()Ljava/lang/String;
    //   4: astore_1
    //   5: new 76	java/io/File
    //   8: dup
    //   9: getstatic 65	com/umeng/a/w:b	Landroid/content/Context;
    ...
    //   19: astore_2
    //   20: aload_2
    //   21: invokestatic 216	com/umeng/a/w:a	(Ljava/io/File;)Z
    //   24: ifeq +10 -> 34
    //   27: aload_2
    ...
    //   38: ifeq -6 -> 32
    //   41: getstatic 65	com/umeng/a/w:b	Landroid/content/Context;
    //   44: aload_1
    ...
    //   52: astore 4
    //   54: aload 4
    //   56: invokestatic 226	c/a/ch:b	(Ljava/io/InputStream;)[B
    //   59: astore 8
    //   61: aload 4
    //   63: invokestatic 229	c/a/ch:c	(Ljava/io/InputStream;)V
    //   66: aload 8
    //   68: areturn
    //   69: astore 6
    //   71: aconst_null
    ...
    //   79: aload 4
    //   81: invokestatic 229	c/a/ch:c	(Ljava/io/InputStream;)V
    //   84: aconst_null
    //   85: areturn
    //   86: astore_3
    //   87: aconst_null
    ...
    //   91: astore 5
    //   93: aload 4
    //   95: invokestatic 229	c/a/ch:c	(Ljava/io/InputStream;)V
    //   98: aload 5
    //   100: athrow
    //   101: astore 5
    //   103: goto -10 -> 93
  ...
  public static class a
  {
    ...
    private File b;
    private FilenameFilter c = new x(this);
    ...
    // ERROR //
    public void a(w.b paramb)
    {
      // Byte code:
      //   0: aload_0
      //   1: getfield 42	com/umeng/a/w$a:b	Ljava/io/File;
      //   4: aload_0
      //   5: getfield 29	com/umeng/a/w$a:c	Ljava/io/FilenameFilter;
      ...
      //   21: aload_1
      //   22: aload_0
      //   23: getfield 42	com/umeng/a/w$a:b	Ljava/io/File;
      ...
      //   92: aload_1
      //   93: aload_0
      //   94: getfield 42	com/umeng/a/w$a:b	Ljava/io/File;
    ...
    public void a(byte[] paramArrayOfByte)
    {
      ...
      while (true)
      {
        ...
        try
        {
          ch.a(localFile, paramArrayOfByte);
