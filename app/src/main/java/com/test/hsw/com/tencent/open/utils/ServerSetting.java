...
public class ServerSetting
{
  ...
  public String getEnvUrl(Context paramContext, String paramString)
  {
    ...
    try
    {
      ...
      if (str1 == null)
      {
        f.e(a, "Get host error. url=" + paramString);
        return paramString;
      }
      str2 = ((SharedPreferences)this.c.get()).getString(str1, null);
      if ((str2 == null) || (str1.equals(str2)))
      {
        f.b(a, "host=" + str1 + ", envHost=" + str2);
        return paramString;
      }
    }
    catch (Exception localException)
    {
      f.e(a, "getEnvUrl url=" + paramString + "error.: " + localException.getMessage());
      return paramString;
    }
    paramString = paramString.replace(str1, str2);
    f.b(a, "return environment url : " + paramString);
    return paramString;
  }
 ...
 * Qualified Name:     com.tencent.open.utils.ServerSetting
