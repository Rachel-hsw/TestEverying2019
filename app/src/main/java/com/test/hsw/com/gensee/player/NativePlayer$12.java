...
class NativePlayer$12
  implements IGSTask
{
  public int doTask()
  {
    if (NativePlayer.access$1() != 0L);
    for (int i = NativePlayer.access$9(this.this$0, NativePlayer.access$1(), this.val$isClose); ; i = 0)
    {
      ...
      {
        localOnTaskRet.onTaskRet(bool, i, "closeAudio");
        return 0;
      }
    }
  }
 ...
 * Qualified Name:     com.gensee.player.NativePlayer.12
