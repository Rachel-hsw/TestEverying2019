...
public final class a
{
  ...
  private String a(Context paramContext, int paramInt)
  {
    ...
    //   29: astore 13
    //   31: aload 13
    //   33: new 61	com/alipay/security/mobile/module/b/a$a
    //   36: dup
    //   37: aload_0
    //   38: iconst_0
    //   39: invokespecial 64	com/alipay/security/mobile/module/b/a$a:<init>	(Lcom/alipay/security/mobile/module/b/a;B)V
      ...
      try
      {
        ...
        if (localSensorManager != null)
        {
          ...
          if ((localList != null) && (localList.size() > 0))
          {
            ...
            str1 = com.alipay.security.mobile.module.a.a.b(localStringBuilder.toString());
          }
        }
  ...
  private static String j()
  {
    ...
    //   27: astore 8
    //   29: aload 8
    //   31: invokestatic 210	com/alipay/security/mobile/module/a/a:a	(Ljava/lang/String;)Z
    //   34: ifne +21 -> 55
    //   37: aload 8
  ...
  private static String k()
  {
    ...
    //   33: ifnull +57 -> 90
    //   36: aload 9
    //   38: invokestatic 210	com/alipay/security/mobile/module/a/a:a	(Ljava/lang/String;)Z
    //   41: ifne -18 -> 23
    //   44: aload 9
    //   46: ldc 180
  ...
  public final String c()
  {
    try
    {
      String str = String.valueOf(new File("/sys/devices/system/cpu/").listFiles(new b(this)).length);
      return str;
    }
    catch (Exception localException)
    {
