  ...
  final void a(JSONObject paramJSONObject, Thread paramThread)
  {
    if (paramThread == null)
    {
      ...
      if (g.r(this.cB).W())
      {
        ...
        r.a(localJSONObject, "bs", r.U(this.cB));
        r.a(localJSONObject, "ss", r.V(this.cB));
        if (localJSONObject.length() > 0)
          r.a(paramJSONObject, "wf", localJSONObject.toString());
      }
      JSONArray localJSONArray = r.X(this.cB);
      if ((localJSONArray != null) && (localJSONArray.length() > 0))
        r.a(paramJSONObject, "wflist", localJSONArray.toString());
