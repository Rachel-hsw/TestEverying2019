...
public class DWMediaPlayer extends MediaPlayer
{
  ...
  private boolean c(ErrorCode paramErrorCode)
  {
    if (this.at == null)
      return false;
    return this.at.onError(this, paramErrorCode.Value(), -1);
  }
    ...
    throws IllegalArgumentException, SecurityException, IllegalStateException, IOException
  {
    ...
    //   0: aload_0
    //   1: aload_2
    //   2: putfield 401	com/bokecc/sdk/mobile/play/DWMediaPlayer:R	Landroid/content/Context;
    //   5: aload_1
    //   6: ldc 251
    //   8: invokevirtual 564	java/lang/String:endsWith	(Ljava/lang/String;)Z
    //   11: ifne +14 -> 25
    //   14: ldc_w 264
    //   17: ldc_w 566
    //   20: invokestatic 269	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   23: pop
    //   24: return
    //   25: new 568	java/io/FileInputStream
    //   28: dup
    //   29: aload_1
    //   30: invokespecial 569	java/io/FileInputStream:<init>	(Ljava/lang/String;)V
    //   33: astore_3
    //   34: aload_3
    //   35: invokevirtual 572	java/io/FileInputStream:available	()I
    //   38: ifgt +17 -> 55
    //   41: aload_0
    //   42: aload_1
    //   43: invokespecial 574	android/media/MediaPlayer:setDataSource	(Ljava/lang/String;)V
    //   46: aload_3
    //   47: ifnull -23 -> 24
    //   50: aload_3
    //   51: invokevirtual 577	java/io/FileInputStream:close	()V
    //   54: return
    //   55: iconst_3
    //   56: newarray byte
    //   58: astore 8
    //   60: aload_3
    //   61: aload 8
    //   63: invokevirtual 581	java/io/FileInputStream:read	([B)I
    //   66: pop
    //   67: ldc_w 583
    //   70: new 94	java/lang/String
    //   73: dup
    //   74: aload 8
    //   76: invokespecial 586	java/lang/String:<init>	([B)V
    //   79: invokevirtual 356	java/lang/String:equals	(Ljava/lang/Object;)Z
    //   82: ifne +17 -> 99
    //   85: aload_0
    //   86: aload_1
    //   87: invokespecial 574	android/media/MediaPlayer:setDataSource	(Ljava/lang/String;)V
    //   90: aload_3
    //   91: ifnull -67 -> 24
    //   94: aload_3
    //   95: invokevirtual 577	java/io/FileInputStream:close	()V
    //   98: return
    //   99: aload_3
    //   100: ifnull +7 -> 107
    //   103: aload_3
    //   104: invokevirtual 577	java/io/FileInputStream:close	()V
    //   107: aload_0
    //   108: aload_1
    //   109: putfield 271	com/bokecc/sdk/mobile/play/DWMediaPlayer:as	Ljava/lang/String;
    //   112: return
    //   113: astore 4
    //   115: aconst_null
    //   116: astore_3
    //   117: ldc_w 588
    //   120: new 112	java/lang/StringBuilder
    //   123: dup
    //   124: invokespecial 113	java/lang/StringBuilder:<init>	()V
    //   127: aload 4
    //   129: invokevirtual 591	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   132: ldc 124
    //   134: invokevirtual 127	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   137: invokevirtual 131	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   140: invokestatic 269	android/util/Log:e	(Ljava/lang/String;Ljava/lang/String;)I
    //   143: pop
    //   144: aload_0
    //   145: getstatic 327	com/bokecc/sdk/mobile/exception/ErrorCode:PROCESS_FAIL	Lcom/bokecc/sdk/mobile/exception/ErrorCode;
    //   148: invokespecial 398	com/bokecc/sdk/mobile/play/DWMediaPlayer:c	(Lcom/bokecc/sdk/mobile/exception/ErrorCode;)Z
    //   151: pop
    //   152: aload_3
    //   153: ifnull -129 -> 24
    //   156: aload_3
    //   157: invokevirtual 577	java/io/FileInputStream:close	()V
    //   160: return
    //   161: astore 5
    //   163: aconst_null
    //   164: astore_3
    ...
    //   166: ifnull +7 -> 173
    //   169: aload_3
    //   170: invokevirtual 577	java/io/FileInputStream:close	()V
    //   173: aload 5
    //   175: athrow
    //   176: astore 5
    //   178: goto -13 -> 165
 ...
 * Qualified Name:     com.bokecc.sdk.mobile.play.DWMediaPlayer
