...
public class a extends d
{
  ...
  public void a(com.himamis.retex.editor.a.f.a parama, StringBuilder paramStringBuilder)
  {
  ...
  {
    paramStringBuilder.append(paramc.f());
  }
  ...
  public void a(g paramg, StringBuilder paramStringBuilder)
  {
    ...
    if (paramg.r().a().g(paramg.b()))
    {
      ...
      label1188: paramStringBuilder.append("\\mathrm{" + paramg.e() + "} ");
      String str1;
      label1325: int i1;
      if (this.e)
      {
  ...
  public void a(com.himamis.retex.editor.a.f.h paramh, StringBuilder paramStringBuilder)
  {
    ...
    if (((paramh.w()) || (paramh.t() > i) || ((paramh.t() == i) && (a(paramh, 0) > i)) || ((paramh.t() == 0) && (paramh != this.a)) || ((paramh.t() == i) && (paramh == this.a))) && (paramStringBuilder.length() > 0) && (paramStringBuilder.charAt(-1 + paramStringBuilder.length()) != '{'))
    {
      ...
      if (paramh.t() != 0)
        break label173;
      if ((paramh.a_() != null) && ((!(paramh.a_() instanceof g)) || (paramh.s() != paramh.a_().x())))
        break label162;
      paramStringBuilder.append("\\triangleleft");
    }
    while (true)
    {
      ...
      i = 0;
      break;
      label162: paramStringBuilder.append("\\triangleright");
      continue;
      label173: a(paramh, paramStringBuilder, 0, paramh.t());
    }
  }
 ...
 * Qualified Name:     com.himamis.retex.editor.a.a.a
