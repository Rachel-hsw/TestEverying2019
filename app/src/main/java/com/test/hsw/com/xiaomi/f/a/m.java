...
public class m
  implements Serializable, Cloneable, org.a.c.b<m, a>
{
  ...
  private static final org.a.c.b.c r = new org.a.c.b.c("category", 11, 8);
  public String a;
  public d b;
  public String c;
  public String d;
  ...
  static
  {
    ...
    localEnumMap.put(a.e, new org.a.c.a.b("request", 2, new org.a.c.a.g(12, l.class)));
  ...
  public boolean a(m paramm)
  {
    ...
    do
    {
      ...
      do
      {
        ...
        while (((bool9) || (bool10)) && ((!bool9) || (!bool10) || (!this.e.a(paramm.e)) || (this.f != paramm.f)));
        bool11 = g();
        bool12 = paramm.g();
      }
      while (((bool11) || (bool12)) && ((!bool11) || (!bool12) || (!this.g.equals(paramm.g))));
      bool13 = h();
      bool14 = paramm.h();
    }
    while (((bool13) || (bool14)) && ((!bool13) || (!bool14) || (!this.h.equals(paramm.h))));
    return true;
  }
    ...
    do
    {
      do
      {
        do
        {
            ...
            do
            {
              do
              {
                do
                {
                    ...
                    do
                    {
                      do
                      {
                        do
                        {
                            ...
                            do
                            {
                              do
                              {
                                do
                                {
                                  ...
                                  if (!a())
                                    break;
                                  i1 = org.a.c.c.a(this.a, paramm.a);
                                }
                                while (i1 != 0);
                              ...
                              if (!b())
                                break;
                              i1 = org.a.c.c.a(this.b, paramm.b);
                            }
                            while (i1 != 0);
                          ...
                          if (!c())
                            break;
                          i1 = org.a.c.c.a(this.c, paramm.c);
                        }
                        while (i1 != 0);
                        i1 = Boolean.valueOf(d()).compareTo(Boolean.valueOf(paramm.d()));
                      }
                      while (i1 != 0);
                      if (!d())
                        break;
                      i1 = org.a.c.c.a(this.d, paramm.d);
                    }
                    while (i1 != 0);
                  ...
                  if (!e())
                    break;
                  i1 = org.a.c.c.a(this.e, paramm.e);
                }
                while (i1 != 0);
              ...
              if (!f())
                break;
              i1 = org.a.c.c.a(this.f, paramm.f);
            }
            while (i1 != 0);
          ...
          if (!g())
            break;
          i1 = org.a.c.c.a(this.g, paramm.g);
        }
        while (i1 != 0);
        i1 = Boolean.valueOf(h()).compareTo(Boolean.valueOf(paramm.h()));
      }
      while (i1 != 0);
      if (!h())
        break;
      i1 = org.a.c.c.a(this.h, paramm.h);
    }
    while (i1 != 0);
    return 0;
  }
 ...
 * Qualified Name:     com.xiaomi.f.a.m
