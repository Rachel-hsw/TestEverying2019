...
public class TDialog extends b
{
  ...
  private static void d(Context paramContext, String paramString)
  {
    ...
    do
      while (true)
      {
        ...
        {
          JSONObject localJSONObject = Util.parseJson(paramString);
          m = localJSONObject.getInt("action");
          str = localJSONObject.getString("msg");
          if (m != 1)
            break;
          if (d == null)
  ...
  private class FbWebViewClient extends WebViewClient
  {
    ...
    public boolean shouldOverrideUrlLoading(WebView paramWebView, String paramString)
    {
      ...
      if (paramString.startsWith("download://"))
      {
        ...
        if ((TDialog.a(TDialog.this) != null) && (TDialog.a(TDialog.this).get() != null))
          ((Context)TDialog.a(TDialog.this).get()).startActivity(localIntent);
        return true;
      }
  ...
  private class THandler extends Handler
  {
    ...
    public THandler(TDialog.OnTimeListener paramLooper, Looper arg3)
    {
      super();
      this.mL = paramLooper;
    }
