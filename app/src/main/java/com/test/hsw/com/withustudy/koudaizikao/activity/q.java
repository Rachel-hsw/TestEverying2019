...
{
  q(p paramp, SectionSummary paramSectionSummary)
  {
  }
  ...
  public void onClick(View paramView)
  {
    ...
    localBundle.putString("subjectName", ChapterSectionListActivity.h(ChapterSectionListActivity.a.a(p.a(this.a))));
    localBundle.putString("subjectId", ChapterSectionListActivity.i(ChapterSectionListActivity.a.a(p.a(this.a))));
    localBundle.putInt("BrushPageFrom", 9);
    ChapterSectionListActivity.a.a(p.a(this.a)).startNewActivity(BrushExcerciseDetailActivity.class, 2130968591, 2130968589, false, localBundle);
  }
}

/* Location:           C:\Androidnixiangzhushou\zikao_classes_dex2jar.jar
 * Qualified Name:     com.withustudy.koudaizikao.activity.q
