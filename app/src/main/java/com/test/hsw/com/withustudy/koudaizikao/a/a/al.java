...
public class al extends a
{
  public void a(n.a parama, String[] paramArrayOfString, int paramInt, Context paramContext)
  {
    ...
    a(localHashMap);
    n.a().a("http://bbs.kdzikao.com/forumTopicPraiseApi/" + paramArrayOfString[2] + "/bbs.page", localHashMap, parama, paramInt);
  }
}

/* Location:           C:\Androidnixiangzhushou\zikao_classes_dex2jar.jar
 * Qualified Name:     com.withustudy.koudaizikao.a.a.al
