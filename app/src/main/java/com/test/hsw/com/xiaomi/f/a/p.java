...
public class p
  implements Serializable, Cloneable, org.a.c.b<p, a>
{
  ...
  static
  {
    ...
    localEnumMap.put(a.e, new org.a.c.a.b("request", 2, new org.a.c.a.g(12, o.class)));
        ...
        do
        {
          ...
          do
          {
            ...
            do
            {
              ...
              while (((bool9) || (bool10)) && ((!bool9) || (!bool10) || (!this.e.a(paramp.e))));
              bool11 = f();
              bool12 = paramp.f();
            }
            while (((bool11) || (bool12)) && ((!bool11) || (!bool12) || (this.f != paramp.f)));
            bool13 = g();
            bool14 = paramp.g();
          }
          while (((bool13) || (bool14)) && ((!bool13) || (!bool14) || (!this.g.equals(paramp.g))));
          bool15 = i();
          bool16 = paramp.i();
        }
        while (((bool15) || (bool16)) && ((!bool15) || (!bool16) || (!this.h.equals(paramp.h))));
        bool17 = j();
        bool18 = paramp.j();
      }
      while (((bool17) || (bool18)) && ((!bool17) || (!bool18) || (!this.i.equals(paramp.i))));
      bool19 = l();
      bool20 = paramp.l();
    }
    while (((bool19) || (bool20)) && ((!bool19) || (!bool20) || (!this.j.equals(paramp.j))));
    return true;
  }
            ...
            do
            {
              do
              {
                do
                {
                    ...
                    do
                    {
                      do
                      {
                        do
                        {
                            ...
                            do
                            {
                              do
                              {
                                do
                                {
                                    ...
                                    do
                                    {
                                      do
                                      {
                                        do
                                        {
                                          ...
                                          if (!a())
                                            break;
                                          i1 = org.a.c.c.a(this.a, paramp.a);
                                        }
                                        while (i1 != 0);
                                      ...
                                      if (!b())
                                        break;
                                      i1 = org.a.c.c.a(this.b, paramp.b);
                                    }
                                    while (i1 != 0);
                                  ...
                                  if (!c())
                                    break;
                                  i1 = org.a.c.c.a(this.c, paramp.c);
                                }
                                while (i1 != 0);
                              ...
                              if (!d())
                                break;
                              i1 = org.a.c.c.a(this.d, paramp.d);
                            }
                            while (i1 != 0);
                          ...
                          if (!e())
                            break;
                          i1 = org.a.c.c.a(this.e, paramp.e);
                        }
                        while (i1 != 0);
                      ...
                      if (!f())
                        break;
                      i1 = org.a.c.c.a(this.f, paramp.f);
                    }
                    while (i1 != 0);
                  ...
                  if (!g())
                    break;
                  i1 = org.a.c.c.a(this.g, paramp.g);
                }
                while (i1 != 0);
                i1 = Boolean.valueOf(i()).compareTo(Boolean.valueOf(paramp.i()));
              }
              while (i1 != 0);
              if (!i())
                break;
              i1 = org.a.c.c.a(this.h, paramp.h);
            }
            while (i1 != 0);
            i1 = Boolean.valueOf(j()).compareTo(Boolean.valueOf(paramp.j()));
          }
          while (i1 != 0);
          if (!j())
            break;
          i1 = org.a.c.c.a(this.i, paramp.i);
        }
        while (i1 != 0);
        i1 = Boolean.valueOf(l()).compareTo(Boolean.valueOf(paramp.l()));
      }
      while (i1 != 0);
      if (!l())
        break;
      i1 = org.a.c.c.a(this.j, paramp.j);
    }
    while (i1 != 0);
    return 0;
  }
 ...
 * Qualified Name:     com.xiaomi.f.a.p
