...
public class AnnoText extends AbsAnno
{
  ...
  public void setFontsize(short paramShort)
  {
    this.fontsize = paramShort;
  }
  ...
  {
    return "AnnoText [id=" + this.id + ", filehandle=" + this.filehandle + ", blockhandle=" + this.blockhandle + ", owner=" + this.owner + ", color=" + this.color + ", fontsize=" + this.fontsize + ", text=" + this.text + ", left=" + this.left + ", right=" + this.right + ", top=" + this.top + ", bottom=" + this.bottom + "," + super.toString() + "]";
  }
}

/* Location:           C:\Androidnixiangzhushou\zikao_classes_dex2jar.jar
 * Qualified Name:     com.gensee.vodpdu.AnnoText
