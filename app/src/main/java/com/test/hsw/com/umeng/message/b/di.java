...
public abstract class di
{
  ...
  protected di(int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    this.n = paramInt1;
    this.o = paramInt2;
  ...
  public boolean b(byte[] paramArrayOfByte, boolean paramBoolean)
  {
    for (int i1 = 0; ; i1++)
    {
      ...
      do
      {
        ...
        {
          return i2;
          if (b(paramArrayOfByte[i1]))
            break;
          i2 = 0;
        }
        while (!paramBoolean);
        if (paramArrayOfByte[i1] == 61)
          break;
        bool = c(paramArrayOfByte[i1]);
        i2 = 0;
      }
      while (!bool);
    }
  ...
  {
    return b(df.f(paramString), true);
  }

  public String j(byte[] paramArrayOfByte)
  {
    return df.f(l(paramArrayOfByte));
  }
 ...
 * Qualified Name:     com.umeng.message.b.di
