...
public class k extends a
{
  public void a(n.a parama, String[] paramArrayOfString, int paramInt, Context paramContext)
  {
    ...
    localHashMap.put("pagenum", paramArrayOfString[3]);
    localHashMap.put("pagecount", paramArrayOfString[4]);
    a(localHashMap);
    n.a().a("http://bbs.kdzikao.com/forumsApi/list/bbs.page", localHashMap, parama, paramInt);
  }
}

/* Location:           C:\Androidnixiangzhushou\zikao_classes_dex2jar.jar
 * Qualified Name:     com.withustudy.koudaizikao.a.a.k
