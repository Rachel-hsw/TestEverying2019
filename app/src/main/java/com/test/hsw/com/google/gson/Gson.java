...
public final class Gson
{
    ...
    throws JsonIOException, JsonSyntaxException
  {
    ...
    //   1: istore_3
    //   2: aload_1
    //   3: invokevirtual 397	com/google/gson/stream/JsonReader:isLenient	()Z
    //   6: istore 4
    //   8: aload_1
    //   9: iload_3
    //   10: invokevirtual 400	com/google/gson/stream/JsonReader:setLenient	(Z)V
    //   13: aload_1
    ...
    //   20: aload_0
    //   21: aload_2
    //   22: invokestatic 406	com/google/gson/reflect/TypeToken:get	(Ljava/lang/reflect/Type;)Lcom/google/gson/reflect/TypeToken;
    //   25: invokevirtual 410	com/google/gson/Gson:getAdapter	(Lcom/google/gson/reflect/TypeToken;)Lcom/google/gson/TypeAdapter;
    //   28: aload_1
    //   29: invokevirtual 416	com/google/gson/TypeAdapter:read	(Lcom/google/gson/stream/JsonReader;)Ljava/lang/Object;
    //   32: astore 10
    //   34: aload_1
    //   35: iload 4
    //   37: invokevirtual 400	com/google/gson/stream/JsonReader:setLenient	(Z)V
    //   40: aload 10
    //   42: areturn
    //   43: astore 8
    //   45: iload_3
    ...
    //   49: aload_1
    //   50: iload 4
    //   52: invokevirtual 400	com/google/gson/stream/JsonReader:setLenient	(Z)V
    //   55: aconst_null
    //   56: areturn
    ...
    //   69: aload_1
    //   70: iload 4
    //   72: invokevirtual 400	com/google/gson/stream/JsonReader:setLenient	(Z)V
    //   75: aload 6
    //   77: athrow
    //   78: astore 7
  ...
  public <T> TypeAdapter<T> getAdapter(TypeToken<T> paramTypeToken)
  {
    ...
    for (int i = 1; ; i = 0)
    {
      while (true)
      {
        localObject1 = (FutureTypeAdapter)((Map)localObject2).get(paramTypeToken);
        if (localObject1 != null)
          break;
        try
        {
          FutureTypeAdapter localFutureTypeAdapter = new FutureTypeAdapter();
