...
public class MessageStore
{
  ...
  boolean a(a parama)
  {
    ...
    synchronized (instance)
    {
      ...
      localContentValues.put("MsdId", parama.h);
      localContentValues.put("Json", parama.a().toString());
      localContentValues.put("SdkVersion", "2.6.0");
      ...
      boolean bool = this.b.insert("MessageStore", null, localContentValues) < -1L;
      int i1 = 0;
      if (bool)
        i1 = 1;
      return i1;
