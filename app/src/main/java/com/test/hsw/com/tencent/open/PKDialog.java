  ...
  implements a.a
{
  ...
  private void createViews()
  {
    ...
    try
    {
      ...
      com.tencent.open.c.b localb = this.mWebView;
      Object[] arrayOfObject = new Object[2];
      arrayOfObject[0] = Integer.valueOf(1);
      arrayOfObject[1] = new Paint();
      localMethod.invoke(localb, arrayOfObject);
  ...
  private static void showProcessDialog(Context paramContext, String paramString)
  {
    ...
    while (true)
    {
      ...
      try
      {
        ...
        int i = localJSONObject.getInt("action");
  ...
  public void onKeyboardShown(int paramInt)
  {
    if ((this.mWeakContext != null) && (this.mWeakContext.get() != null))
      if ((paramInt >= this.mWebviewHeight) || (2 != ((Context)this.mWeakContext.get()).getResources().getConfiguration().orientation))
        break label69;
    label69: for (this.mWebView.getLayoutParams().height = paramInt; ; this.mWebView.getLayoutParams().height = this.mWebviewHeight)
    {
    ...
    implements IUiListener
  {
    ...
    public void onComplete(Object paramObject)
    {
      ...
      g.a().a(this.mAction + "_H5", SystemClock.elapsedRealtime(), 0L, 0L, localJSONObject.optInt("ret", -6), this.mUrl, false);
      if (this.mWeakL != null)
      {
        this.mWeakL.onComplete(localJSONObject);
        this.mWeakL = null;
      }
    }
  ...
  private class THandler extends Handler
  {
    ...
    public THandler(PKDialog.OnTimeListener paramLooper, Looper arg3)
    {
      super();
      this.mL = paramLooper;
    }
    ...
    public void handleMessage(Message paramMessage)
    {
      ...
      do
      {
        ...
        PKDialog.access$800((Context)PKDialog.this.mWeakContext.get(), (String)paramMessage.obj);
        return;
      }
      while ((PKDialog.this.mWeakContext == null) || (PKDialog.this.mWeakContext.get() == null));
      PKDialog.access$900((Context)PKDialog.this.mWeakContext.get(), (String)paramMessage.obj);
    }
  }
}
