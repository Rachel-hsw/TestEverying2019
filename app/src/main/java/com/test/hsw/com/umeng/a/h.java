...
public class h
{
  ...
  public h(Context paramContext, WebView paramWebView, WebChromeClient paramWebChromeClient)
  {
    this.a = paramContext;
    paramWebView.getSettings().setJavaScriptEnabled(true);
  ...
  final class a extends WebChromeClient
  {
    ...
    public boolean onJsPrompt(WebView paramWebView, String paramString1, String paramString2, String paramString3, JsPromptResult paramJsPromptResult)
    {
      ...
      while (true)
      {
        ...
        break;
        g.a().a(h.a(h.this), str2, localHashMap, i);
        continue;
        ...
        try
        {
          ...
          if ("".equals(str1))
            str1 = null;
          g.a().a(h.a(h.this), localJSONObject1.getString("tag"), str1, localJSONObject1.optInt("duration"), 1);
        }
