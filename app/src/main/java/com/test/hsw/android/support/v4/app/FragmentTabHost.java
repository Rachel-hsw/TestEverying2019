  ...
  private FragmentTransaction doTabChanged(String paramString, FragmentTransaction paramFragmentTransaction)
  {
    ...
    while (true)
    {
      ...
      if (this.mLastTab != localObject1)
      {
        ...
        if (localObject1 != null)
        {
          if (localObject1.fragment != null)
            break label190;
          TabInfo.access$102(localObject1, Fragment.instantiate(this.mContext, localObject1.clss.getName(), localObject1.args));
      ...
      while (true)
      {
        ...
        label190: paramFragmentTransaction.attach(localObject1.fragment);
      }
