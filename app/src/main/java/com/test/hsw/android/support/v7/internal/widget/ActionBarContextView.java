  ...
  implements ViewPropertyAnimatorListener
{
  ...
  protected void onLayout(boolean paramBoolean, int paramInt1, int paramInt2, int paramInt3, int paramInt4)
  {
    ...
    label87: int i2;
    label99: int n;
    label259: ActionMenuView localActionMenuView;
    if (bool1)
    {
    ...
    label308: label318: label328: label342: for (boolean bool2 = true; ; bool2 = false)
    {
  ...
  protected void onMeasure(int paramInt1, int paramInt2)
  {
    ...
    int i11;
    label304: int i12;
    label330: label337: int i7;
    label366: int i8;
    label396: label416: int i5;
    label452: int i6;
    ...
    while (true)
    {
      ...
      label505: i12 = 8;
      break label330;
      label512: i1 = measureChildView(this.mTitleLayout, i1, i3, 0);
      break label337;
      label530: i7 = -2147483648;
      break label366;
      label538: i = -2147483648;
      break label396;
      label545: i8 = i2;
      break label416;
      label552: setMeasuredDimension(k, i5);
      return;
      label561: setMeasuredDimension(k, m);
      return;
      label570: i6 = i5;
    }
  }
