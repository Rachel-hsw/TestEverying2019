  ...
  implements LayoutInflaterFactory
{
  ...
  public void enqueueAction(Runnable paramRunnable, boolean paramBoolean)
  {
    ...
    //   1: ifne +7 -> 8
    //   4: aload_0
    //   5: invokespecial 511	android/support/v4/app/FragmentManagerImpl:checkStateLoss	()V
    //   8: aload_0
    //   9: monitorenter
    //   10: aload_0
    ...
    //   39: athrow
    //   40: aload_0
    //   41: getfield 477	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   44: ifnonnull +14 -> 58
    //   47: aload_0
    //   48: new 242	java/util/ArrayList
    //   51: dup
    //   52: invokespecial 243	java/util/ArrayList:<init>	()V
    //   55: putfield 477	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   58: aload_0
    //   59: getfield 477	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    //   62: aload_1
    //   63: invokevirtual 247	java/util/ArrayList:add	(Ljava/lang/Object;)Z
    //   66: pop
    //   67: aload_0
    //   68: getfield 477	android/support/v4/app/FragmentManagerImpl:mPendingActions	Ljava/util/ArrayList;
    ...
    //   82: getfield 517	android/support/v4/app/FragmentActivity:mHandler	Landroid/os/Handler;
    //   85: aload_0
    //   86: getfield 128	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   89: invokevirtual 523	android/os/Handler:removeCallbacks	(Ljava/lang/Runnable;)V
    //   92: aload_0
    //   93: getfield 218	android/support/v4/app/FragmentManagerImpl:mActivity	Landroid/support/v4/app/FragmentActivity;
    //   96: getfield 517	android/support/v4/app/FragmentActivity:mHandler	Landroid/os/Handler;
    //   99: aload_0
    //   100: getfield 128	android/support/v4/app/FragmentManagerImpl:mExecCommit	Ljava/lang/Runnable;
    //   103: invokevirtual 527	android/os/Handler:post	(Ljava/lang/Runnable;)Z
    //   106: pop
    //   107: aload_0
    //   108: monitorexit
    //   109: return
  ...
  void moveToState(Fragment paramFragment, int paramInt1, int paramInt2, int paramInt3, boolean paramBoolean)
  {
    ...
    if ((paramFragment.mDeferStart) && (paramFragment.mState < 4) && (paramInt1 > 3))
      paramInt1 = 3;
    label486: ViewGroup localViewGroup;
    ...
    while (true)
    {
      ...
      if (paramFragment.mView != null)
      {
        ...
        {
          ViewCompat.setSaveFromParentEnabled(paramFragment.mView, false);
          label721: if (localViewGroup != null)
          {
      ...
      case 2:
        ...
        if ((paramFragment.mView != null) && (paramFragment.mContainer != null))
          if ((this.mCurState <= 0) || (this.mDestroyed))
            break label1506;
        label1370: label1506: for (Animation localAnimation1 = loadAnimation(paramFragment, paramInt2, false, paramInt3); ; localAnimation1 = null)
        {
  ...
  public View onCreateView(View paramView, String paramString, Context paramContext, AttributeSet paramAttributeSet)
  {
    ...
    for (String str2 = localTypedArray.getString(0); ; str2 = str1)
    {
      ...
      int k;
      label294: Fragment localFragment2;
      if (i != -1)
      {
        ...
        label354: if ((this.mCurState >= 1) || (!localFragment2.mFromLayout))
          break label559;
      ...
      while (true)
      {
        ...
        label429: k = j;
        break label294;
        label436: if (localFragment1.mInLayout)
        ...
        break label354;
        label559: moveToState(localFragment2);
      }
      label568: if (i != 0)
      ...
      if (paramArrayList != null)
      {
        ...
        if (m < paramArrayList.size())
        {
          ...
          for (localFragment2.mTarget = ((Fragment)this.mActive.get(localFragment2.mTargetIndex)); ; localFragment2.mTarget = null)
          {
            m++;
            break;
            label470: Log.w("FragmentManager", "Re-attaching retained fragment " + localFragment2 + " target no longer exists: " + localFragment2.mTargetIndex);
          }
        }
      }
