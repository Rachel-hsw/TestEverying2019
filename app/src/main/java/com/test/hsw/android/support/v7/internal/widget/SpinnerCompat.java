    ...
    implements SpinnerCompat.SpinnerPopup
  {
    ...
    void computeContentWidth()
    {
      ...
      if (localDrawable != null)
      {
        ...
        {
          i3 = SpinnerCompat.this.mTempRect.right;
          i = i3;
          ...
          if (SpinnerCompat.this.mDropDownWidth != -2)
            break label245;
          i1 = SpinnerCompat.this.measureContentWidth((SpinnerAdapter)this.mAdapter, getBackground());
      ...
      while (true)
      {
        ...
        for (int n = i + (m - k - getWidth()); ; n = i + j)
        {
          ...
          return;
          i3 = -SpinnerCompat.this.mTempRect.left;
          break;
          ...
          i = 0;
          break label46;
          label245: if (SpinnerCompat.this.mDropDownWidth == -1)
          {
