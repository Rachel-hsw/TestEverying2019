...
public class ViewPager extends ViewGroup
{
    ...
    else
    {
      while (true)
      {
        if ((i10 > paramItemInfo1.position) || (i11 >= this.mItems.size()))
          break label371;
        ItemInfo localItemInfo4 = (ItemInfo)this.mItems.get(i11);
        while (true)
          if ((i10 > localItemInfo4.position) && (i11 < -1 + this.mItems.size()))
          {
            i11++;
            localItemInfo4 = (ItemInfo)this.mItems.get(i11);
            continue;
            f1 = 0.0F;
            break;
          }
  ...
  private ItemInfo infoForCurrentScrollPosition()
  {
    ...
    int m;
    Object localObject;
    label49: ItemInfo localItemInfo1;
    ...
    if (i > 0)
    {
      ...
      {
        localItemInfo1 = (ItemInfo)this.mItems.get(k);
    ...
    for (ItemInfo localItemInfo2 = localItemInfo3; ; localItemInfo2 = localItemInfo1)
    {
  ...
  public void addView(View paramView, int paramInt, ViewGroup.LayoutParams paramLayoutParams)
  {
    ...
    for (ViewGroup.LayoutParams localLayoutParams = generateLayoutParams(paramLayoutParams); ; localLayoutParams = paramLayoutParams)
    {
      ...
      localLayoutParams1.isDecor |= paramView instanceof Decor;
      if (this.mInLayout)
      {
  ...
  void populate(int paramInt)
  {
    ...
    if (this.mCurItem != paramInt)
      ...
      {
        i16 = 66;
        ItemInfo localItemInfo13 = infoForPosition(this.mCurItem);
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        for (ItemInfo localItemInfo3 = addNewItem(this.mCurItem, i1); ; localItemInfo3 = localItemInfo2)
        {
          ...
          if (localItemInfo3 != null)
          {
            ...
            if (i6 < 0)
              break label676;
            localItemInfo7 = (ItemInfo)this.mItems.get(i6);
            i7 = getClientWidth();
            if (i7 > 0)
              break label682;
            f1 = 0.0F;
            ...
            if (f3 < 2.0F)
            {
              if (i12 >= this.mItems.size())
                break label889;
              localItemInfo8 = (ItemInfo)this.mItems.get(i12);
              if (i7 > 0)
                break label895;
              f4 = 0.0F;
            }
          ...
          while (true)
          {
            ...
            label554: localPagerAdapter.setPrimaryItem(this, i2, localObject1);
            this.mAdapter.finishUpdate(this);
            int i3 = getChildCount();
            for (int i4 = 0; i4 < i3; i4++)
            {
            ...
            i1++;
            break;
            label676: localItemInfo7 = null;
            break label358;
            label682: f1 = 2.0F - localItemInfo3.widthFactor + getPaddingLeft() / i7;
            break label372;
            label704: if ((i9 == localItemInfo7.position) && (!localItemInfo7.scrolling))
            {
              ...
              if (i11 < 0)
                break label778;
              localItemInfo7 = (ItemInfo)this.mItems.get(i11);
            }
            while (true)
            {
              i9--;
              break;
              label778: localItemInfo7 = null;
              continue;
              label784: if ((localItemInfo7 != null) && (i9 == localItemInfo7.position))
              {
            ...
            label889: localItemInfo8 = null;
            break label466;
            label895: f4 = 2.0F + getPaddingRight() / i7;
          }
          label911: ItemInfo localItemInfo12;
          label980: Object localObject3;
          float f6;
          if ((i15 == ((ItemInfo)localObject2).position) && (!((ItemInfo)localObject2).scrolling))
          {
            this.mItems.remove(i14);
            this.mAdapter.destroyItem(this, i15, ((ItemInfo)localObject2).object);
            if (i14 < this.mItems.size())
            {
              localItemInfo12 = (ItemInfo)this.mItems.get(i14);
              float f10 = f3;
          ...
          while (true)
          {
            ...
            break label980;
            label1016: if ((localObject2 != null) && (i15 == ((ItemInfo)localObject2).position))
            {
              float f8 = f3 + ((ItemInfo)localObject2).widthFactor;
              i14++;
              if (i14 < this.mItems.size());
              for (ItemInfo localItemInfo11 = (ItemInfo)this.mItems.get(i14); ; localItemInfo11 = null)
              {
            ...
            ItemInfo localItemInfo9 = addNewItem(i15, i14);
            i14++;
            float f5 = f3 + localItemInfo9.widthFactor;
            if (i14 < this.mItems.size());
            for (ItemInfo localItemInfo10 = (ItemInfo)this.mItems.get(i14); ; localItemInfo10 = null)
            {
