  ...
  implements FragmentManager.BackStackEntry, Runnable
{
  ...
  public void dump(String paramString, PrintWriter paramPrintWriter, boolean paramBoolean)
  {
    ...
    if (this.mHead != null)
    {
      ...
      Op localOp1 = this.mHead;
      int i = 0;
      Op localOp2 = localOp1;
      while (localOp2 != null)
      {
        String str2;
        int j;
        ...
        default:
          ...
          if ((localOp2.removed == null) || (localOp2.removed.size() <= 0))
            break label808;
          j = 0;
          label645: if (j >= localOp2.removed.size())
            break label808;
        ...
        label808: localOp2 = localOp2.next;
        i++;
      }
    }
  }
  ...
  public TransitionState popFromBackStack(boolean paramBoolean, TransitionState paramTransitionState, SparseArray<Fragment> paramSparseArray1, SparseArray<Fragment> paramSparseArray2)
  {
    ...
    label263: for (int m = 0; ; m = localOp.popExitAnim)
      switch (localOp.cmd)
      {
      default:
        ...
        break label103;
        label244: j = this.mTransition;
        break label110;
        label253: k = localOp.popEnterAnim;
        break label128;
      case 1:
      case 2:
      case 3:
  ...
  public void run()
  {
    ...
    for (TransitionState localTransitionState = beginTransition(localSparseArray1, localSparseArray2, false); ; localTransitionState = null)
    {
      int i;
      label105: int j;
      label112: Op localOp;
      ...
      if (localTransitionState != null)
      {
        ...
        if (localTransitionState == null)
          break label234;
        k = 0;
        label130: if (localTransitionState == null)
          break label244;
      }
      label225: label234: label244: for (int m = 0; ; m = localOp.exitAnim)
        switch (localOp.cmd)
        {
        default:
          throw new IllegalArgumentException("Unknown cmd: " + localOp.cmd);
        ...
        if (this.mManager.mAdded != null)
        {
          ...
          if (n < this.mManager.mAdded.size())
          {
            ...
            while (true)
            {
              n++;
              break;
              label428: if (localOp.removed == null)
