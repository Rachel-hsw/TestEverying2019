  ...
  implements LayoutInflaterFactory, MenuBuilder.Callback
{
      ...
      while (this.mSubDecor == null)
      {
        ...
        for (this.mSubDecor = ((ViewGroup)localLayoutInflater.inflate(R.layout.abc_screen_simple_overlay_action_mode, null)); ; this.mSubDecor = ((ViewGroup)localLayoutInflater.inflate(R.layout.abc_screen_simple, null)))
        {
          if (Build.VERSION.SDK_INT < 21)
            break label310;
          ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new AppCompatDelegateImplV7.2(this));
          break;
        }
        label310: ((FitWindowsViewGroup)this.mSubDecor).setOnFitSystemWindowsListener(new AppCompatDelegateImplV7.3(this));
      }
  ...
  private PanelFeatureState getPanelState(int paramInt, boolean paramBoolean)
  {
    ...
    {
      PanelFeatureState localPanelFeatureState = new PanelFeatureState(paramInt);
  ...
  private boolean onKeyUpPanel(int paramInt, KeyEvent paramKeyEvent)
  {
    ...
    label234: label239: for (boolean bool3 = preparePanel(localPanelFeatureState, paramKeyEvent); ; bool3 = bool1)
    {
      if (bool3)
      {
  ...
  private void openPanel(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent)
  {
    ...
    label113: label119: label123: label125: WindowManager localWindowManager;
    label189: ViewGroup.LayoutParams localLayoutParams1;
    while (true)
    {
      return;
      int k;
      ...
      if ((localWindowManager == null) || (!preparePanel(paramPanelFeatureState, paramKeyEvent)))
        continue;
    ...
    label409: label411: label441: label447: for (ViewGroup.LayoutParams localLayoutParams2 = new ViewGroup.LayoutParams(-2, -2); ; localLayoutParams2 = localLayoutParams1)
    {
  ...
  private boolean preparePanel(PanelFeatureState paramPanelFeatureState, KeyEvent paramKeyEvent)
  {
    ...
    label275: paramPanelFeatureState.refreshMenuContent = false;
    label280: paramPanelFeatureState.menu.stopDispatchingItemsChanged();
    ...
    label412: label435: for (boolean bool = true; ; bool = false)
    {
  ...
  private int updateStatusGuard(int paramInt)
  {
    ...
    for (int j = m; ; j = 0)
    {
      ...
      while (true)
      {
        ...
        n = 0;
        break;
        label279: ViewGroup.LayoutParams localLayoutParams = this.mStatusGuard.getLayoutParams();
  ...
  ActionMode startSupportActionModeFromWindow(ActionMode.Callback paramCallback)
  {
    ...
    while (true)
    {
      try
      {
        ActionMode localActionMode2 = this.mAppCompatCallback.onWindowStartingSupportActionMode(localActionModeCallbackWrapperV7);
      ...
      catch (AbstractMethodError localAbstractMethodError)
      {
        ...
        localTheme2.setTo(localTheme1);
        localTheme2.applyStyle(localTypedValue.resourceId, true);
        Object localObject = new ContextThemeWrapper(this.mContext, 0);
        ...
        if (this.mActionModePopup != null)
          continue;
        boolean bool = true;
        StandaloneActionMode localStandaloneActionMode = new StandaloneActionMode(localContext, localActionBarContextView, localActionModeCallbackWrapperV7, bool);
      ...
      ActionMode localActionMode1 = null;
    }
  }
