...
public class ListPopupWindow
{
  ...
  private int buildDropDown()
  {
    ...
    if (this.mDropDownList == null)
    {
      ...
      if (!this.mModal)
      {
        ...
        default:
          ...
          i2 = localView2.getMeasuredHeight() + localLayoutParams3.topMargin + localLayoutParams3.bottomMargin;
    ...
    while (true)
    {
      ...
      while (true)
      {
        label314: Drawable localDrawable = this.mPopup.getBackground();
        int i1;
        int j;
        if (localDrawable != null)
        {
          localDrawable.getPadding(this.mTempRect);
          i1 = this.mTempRect.top + this.mTempRect.bottom;
      ...
      label697: localObject = localDropDownListView;
      i2 = 0;
    }
  }
  ...
  public void show()
  {
    ...
    if (this.mPopup.isShowing())
    {
      ...
      if (this.mDropDownWidth == i)
      {
        ...
        if (this.mDropDownWidth != i)
          break label177;
        label68: localPopupWindow4.setWindowLayoutMode(i, 0);
      }
      while (true)
      {
        ...
        label177: i = 0;
        break label68;
        label182: PopupWindow localPopupWindow3 = this.mPopup;
        if (this.mDropDownWidth == i);
        for (int i1 = i; ; i1 = 0)
        {
        ...
        label216: if (this.mDropDownHeight == -2)
          continue;
    ...
    while (true)
    {
      ...
      k = 0;
      break label244;
      label426: if (this.mDropDownHeight == -2)
      {
  ...
  private static class DropDownListView extends ListViewCompat
  {
    ...
    public boolean onForwardedEvent(MotionEvent paramMotionEvent, int paramInt)
    {
      ...
      for (int j = 0; ; j = 1)
      {
        ...
        setPressedItem(localView, i3, i1, i2);
        if (i != 1)
          break;
        clickPressedItem(localView, i3);
        break;
        if (this.mScrollHelper == null)
          break label95;
    ...
    public boolean onTouch(View paramView, MotionEvent paramMotionEvent)
    {
      ...
      if (bool1)
      {
        if (this.mWasLongPress)
          bool3 = onTouchForwarded(paramMotionEvent);
        while (true)
        {
