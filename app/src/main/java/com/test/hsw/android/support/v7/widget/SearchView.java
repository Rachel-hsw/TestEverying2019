  ...
  implements CollapsibleActionView
{
  ...
  private Intent createVoiceAppSearchIntent(Intent paramIntent, SearchableInfo paramSearchableInfo)
  {
    ...
    if (Build.VERSION.SDK_INT >= 8)
    {
      ...
      if (paramSearchableInfo.getVoicePromptTextId() != 0)
      {
        ...
        {
          str4 = localResources.getString(paramSearchableInfo.getVoiceLanguageId());
    ...
    while (true)
    {
      localIntent2.putExtra("android.speech.extra.LANGUAGE_MODEL", str2);
      localIntent2.putExtra("android.speech.extra.PROMPT", str3);
      localIntent2.putExtra("android.speech.extra.LANGUAGE", str4);
      localIntent2.putExtra("android.speech.extra.MAX_RESULTS", i);
      String str5 = null;
      if (localComponentName == null);
      while (true)
      {
        localIntent2.putExtra("calling_package", str5);
        ...
        return localIntent2;
        str5 = localComponentName.flattenToShortString();
      }
      str2 = str1;
      i = 1;
      continue;
  ...
  private boolean hasVoiceSearch()
  {
    ...
    {
      boolean bool1 = this.mSearchable.getVoiceSearchEnabled();
      i = 0;
      if (bool1)
      {
    ...
    while (true)
    {
      ...
      return i;
      label76: boolean bool2 = this.mSearchable.getVoiceSearchLaunchRecognizer();
      localIntent = null;
      if (!bool2)
        continue;
  ...
  private boolean onItemClicked(int paramInt1, int paramInt2, String paramString)
  {
    ...
    {
      boolean bool = this.mOnSuggestionListener.onSuggestionClick(paramInt1);
      i = 0;
      if (bool);
    }
    else
