...
public class SwitchCompat extends CompoundButton
{
  ...
  private void stopDrag(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      int k = 0;
      break;
      label108: boolean bool = false;
      continue;
      label113: if (f > 0.0F)
        continue;
      bool = false;
      continue;
      label125: bool = getTargetCheckedState();
      continue;
      label133: bool = m;
    }
  }
  ...
  public void draw(Canvas paramCanvas)
  {
    ...
    if (this.mThumbDrawable != null)
    {
      ...
      label196: this.mTrackDrawable.setBounds(i, i6, k, i5);
    }
    label306: label313: label320: label331: for (int i1 = i4; ; i1 = n)
    {
      if (this.mThumbDrawable != null)
      {
