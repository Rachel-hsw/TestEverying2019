...
public class LinearLayoutCompat extends ViewGroup
{
  ...
  void measureHorizontal(int paramInt1, int paramInt2)
  {
    ...
    for (int i63 = i; ; i63 = i)
    {
      ...
      i6 = 0;
      break;
      label241: if (localView4.getVisibility() != 8)
        break label286;
    ...
    label286: if (hasDividerBeforeChildAt(i8))
    ...
    if ((i2 == 1073741824) && (localLayoutParams3.width == 0) && (localLayoutParams3.weight > 0.0F))
      if (i6 != 0)
      {
        ...
        label399: if ((i3 == 1073741824) || (localLayoutParams3.height != -1))
          break label2304;
        i52 = 1;
      }
    for (int i53 = 1; ; i53 = 0)
    {
      ...
      if (bool1)
      {
        ...
        if (i67 != -1)
        {
          if (localLayoutParams3.gravity >= 0)
            break label867;
          i68 = this.mGravity;
          label492: int i69 = (0xFFFFFFFE & (i68 & 0x70) >> 4) >> 1;
      ...
      {
        i59 = 1;
        label564: if (localLayoutParams3.weight <= 0.0F)
          break label890;
        if (i53 == 0)
          break label883;
      }
      int i61;
      int i60;
      label676: label732: label865: label867: label883: for (int i66 = i54; ; i66 = i55)
      {
        i61 = Math.max(m, i66);
        i60 = k;
        i8 += getChildrenSkipCount(localView4, i8);
        ...
        if (f7 == 0.0F)
        {
          ...
          if (i6 == 0)
            break label825;
          this.mTotalLength += i50 + localLayoutParams3.leftMargin + localLayoutParams3.rightMargin + getNextLocationOffset(localView4);
        }
        while (true)
        {
          if (!bool2)
          ...
          this.mTotalLength = Math.max(i51, i51 + i50 + localLayoutParams3.leftMargin + localLayoutParams3.rightMargin + getNextLocationOffset(localView4));
        }
        break label399;
      ...
      label918: if ((this.mTotalLength > 0) && (hasDividerBeforeChildAt(i1)))
        this.mTotalLength += this.mDividerWidth;
      int i9;
      ...
      for (int i10 = Math.max(i, i9); ; i10 = i)
      {
        ...
        while (true)
        {
          ...
          while (true)
          {
            ...
            label1924: label1931: label1937: for (int i37 = this.mGravity; ; i37 = localLayoutParams1.gravity)
            {
  ...
  void measureVertical(int paramInt1, int paramInt2)
  {
    ...
    int i59;
    int i57;
    label190: LayoutParams localLayoutParams3;
    float f7;
    int i46;
    if (i8 < i1)
    {
    ...
    for (int i47 = 1; ; i47 = 0)
    {
      ...
      {
        i53 = 1;
        label572: if (localLayoutParams3.weight <= 0.0F)
          break label665;
        if (i47 == 0)
          break label658;
      }
      int i55;
      int i54;
      label658: for (int i60 = i48; ; i60 = i49)
      {
        i55 = Math.max(m, i60);
        i54 = k;
        i8 += getChildrenSkipCount(localView4, i8);
      ...
      while (true)
      {
        ...
        label1395: label1402: for (i26 = 1; ; i26 = 0)
        {
