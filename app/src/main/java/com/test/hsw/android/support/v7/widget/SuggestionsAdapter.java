  ...
  implements View.OnClickListener
{
  ...
  public void bindView(View paramView, Context paramContext, Cursor paramCursor)
  {
    ...
    for (int i = paramCursor.getInt(this.mFlagsCol); ; i = 0)
    {
      ...
      while (true)
      {
        ...
        return;
        label239: localObject = getStringOrNull(paramCursor, this.mText2Col);
        break;
  ...
  public CharSequence convertToString(Cursor paramCursor)
  {
    ...
    do
    {
      ...
      str2 = getColumnString(paramCursor, "suggest_text_1");
    }
    while (str2 == null);
    return str2;
  }
  ...
  public Cursor runQueryOnBackgroundThread(CharSequence paramCharSequence)
  {
    ...
    try
    {
      Cursor localCursor = getSearchManagerSuggestions(this.mSearchable, str, 50);
      if (localCursor != null)
      {
