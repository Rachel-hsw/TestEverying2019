  ...
  implements MenuPresenter, View.OnKeyListener, ViewTreeObserver.OnGlobalLayoutListener, AdapterView.OnItemClickListener, PopupWindow.OnDismissListener
{
  ...
  private int measureContentWidth()
  {
    ...
    while (true)
    {
      ...
      i1 = i3;
      break;
      label155: localView2 = localView1;
      break label68;
      i3 = i1;
    }
  }
  ...
  private class MenuAdapter extends BaseAdapter
  {
    ...
    {
      if (paramView == null);
      for (View localView = MenuPopupHelper.this.mInflater.inflate(MenuPopupHelper.ITEM_LAYOUT, paramViewGroup, false); ; localView = paramView)
      {
