...
public class ViewCompat
{
    ...
    implements ViewCompat.ViewCompatImpl
  {
    ...
    {
      int i = 1;
      int j = paramScrollingView.computeHorizontalScrollOffset();
      int k = paramScrollingView.computeHorizontalScrollRange() - paramScrollingView.computeHorizontalScrollExtent();
      if (k == 0)
        i = 0;
      do
        while (true)
    ...
    {
      int i = 1;
      int j = paramScrollingView.computeVerticalScrollOffset();
      int k = paramScrollingView.computeVerticalScrollRange() - paramScrollingView.computeVerticalScrollExtent();
      if (k == 0)
        i = 0;
      do
        while (true)
