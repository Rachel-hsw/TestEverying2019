...
class MediaControllerCompatApi21
{
  ...
  {
    List localList = ((MediaController)paramObject).getQueue();
    if (localList == null)
      return null;
  ...
  static class CallbackProxy<T extends MediaControllerCompatApi21.Callback> extends MediaController.Callback
  {
