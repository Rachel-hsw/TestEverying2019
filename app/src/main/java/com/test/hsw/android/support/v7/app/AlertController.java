...
class AlertController
{
  ...
  private boolean setupButtons()
  {
    ...
    while (true)
    {
      ...
      i = 1;
      break;
      label195: this.mButtonNegative.setText(this.mButtonNegativeText);
      this.mButtonNegative.setVisibility(0);
      i |= 2;
      break label95;
      label221: this.mButtonNeutral.setText(this.mButtonNeutralText);
  ...
  private void setupView()
  {
    ...
    if (this.mView != null)
    {
      ...
      if (localView2 != null)
        i = 1;
      if ((i == 0) || (!canTextInput(localView2)))
    ...
    while (true)
    {
      ...
      localView2 = null;
      break;
      label346: localFrameLayout1.setVisibility(8);
    }
  }
  ...
  public static class AlertParams
  {
    ...
    {
      ListView localListView = (ListView)this.mInflater.inflate(paramAlertController.mListLayout, null);
      Object localObject;
      if (this.mIsMultiChoice)
        if (this.mCursor == null)
        {
          localObject = new AlertController.AlertParams.1(this, this.mContext, paramAlertController.mMultiChoiceItemLayout, 16908308, this.mItems, localListView);
      ...
      while (true)
      {
        ...
        return;
        localObject = new AlertController.AlertParams.2(this, this.mContext, this.mCursor, false, localListView, paramAlertController);
        break;
        if (this.mIsSingleChoice);
        ...
        label209: localObject = new AlertController.CheckedItemAdapter(this.mContext, i, 16908308, this.mItems);
        break;
        label232: Context localContext = this.mContext;
