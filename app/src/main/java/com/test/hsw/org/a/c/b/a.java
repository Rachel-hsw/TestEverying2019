...
public class a extends f
{
  ...
  public a(org.a.c.c.d paramd, boolean paramBoolean1, boolean paramBoolean2)
  {
    super(paramd);
  ...
  {
    if (paramInt < 0)
      throw new org.a.c.f("Negative length: " + paramInt);
    if (this.d)
    {
      this.c -= paramInt;
      if (this.c < 0)
        throw new org.a.c.f("Message length exceeded: " + paramInt);
    }
  }
    ...
    implements h
  {
    ...
    {
      a locala = new a(paramd, this.a, this.b);
      if (this.c != 0)
        locala.c(this.c);
      return locala;
    }
