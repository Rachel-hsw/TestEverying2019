package com.rachel.socketdemo_pigchatroom.util;
...
import com.rachel.socketdemo_pigchatroom.MyApplication;
import com.rachel.socketdemo_pigchatroom.R;
import com.rachel.socketdemo_pigchatroom.base.BaseRunnable;
...
public class ToastUtils {
    ...
    private void showToast(String msg, boolean showImg, int imgId, int type) {
        showToast(MyApplication.get(), msg, showImg, imgId, type);
    }
